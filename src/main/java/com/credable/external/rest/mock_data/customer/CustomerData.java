...
public class CustomerData {
    ...
    public CustomerData() {
        customers.add(new CustomerObj(  "234774784", "John", "M.", "Doe", Gender.MALE, IdType.PASSPORT, "A1234567", "john" +
                ".doe@example.com", "1234567890", 5000.0, Status.ACTIVE, LocalDateTime.of(1990, 5, 10, 0, 0), LocalDateTime.now(), LocalDateTime.now()));
        customers.add(new CustomerObj(  "318411216", "Jane", "A.", "Smith", Gender.FEMALE, IdType.NATIONAL_ID, "B9876543", "jane" +
                ".smith@example.com", "2345678901", 6000.0, Status.ACTIVE, LocalDateTime.of(1985, 8, 15, 0, 0), LocalDateTime.now(), LocalDateTime.now()));
        customers.add(new CustomerObj(  "340397370", "Alice", "B.", "Johnson", Gender.FEMALE, IdType.DRIVERS_LICENSE, "C7654321",
        ...
        customers.add(new CustomerObj(  "366585630", "Bob", "C.", "Williams",Gender. MALE, IdType.NATIONAL_ID, "D6543210", "bob" +
                ".williams@example.com", "4567890123", 5500.0, Status.INACTIVE, LocalDateTime.of(1988, 2, 5, 0, 0), LocalDateTime.now(), LocalDateTime.now()));
        customers.add(new CustomerObj(  "397178638", "Charlie", "D.", "Brown", Gender.MALE, IdType.VOTERS_ID, "E5432109",
