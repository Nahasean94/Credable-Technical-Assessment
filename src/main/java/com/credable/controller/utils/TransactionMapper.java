package com.credable.controller.utils;
...
public class TransactionMapper {
    ...
    // Convert long timestamp to XMLGregorianCalendar
    private static XMLGregorianCalendar toXMLGregorianCalendar(long timestamp) {
        try {
